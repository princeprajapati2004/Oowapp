...
export interface InvoicePdfInput {
  ...
  // which reuses this same PDF generator (final-bill-page.tsx / order-tracker.tsx).
 ...
 * pre-order bill review (final-bill-page.tsx) and the live order/invoice tracker (order-tracker.tsx). */
