...
export function OrderSheet({
  ...
  // Reset transient payment-intent UI whenever the sheet transitions from
  // closed to open, so reopening never shows a stale "waiting for approval"
  // state from a previous visit — adjusted during render (not an effect), see
